...
def face_matching(
    ...
    Returns:
        dict: Dictionary containing verification result, distance, and threshold.
    """
    ...
    # Return dictionary with full information
    return {
        "verified": bool(dis < threshold),
        "distance": float(dis),
        "threshold": float(threshold),
        "metric": distance_metric_name
    }
